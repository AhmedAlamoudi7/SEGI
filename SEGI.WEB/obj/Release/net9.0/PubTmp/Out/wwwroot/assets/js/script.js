    ...
    $(document).ready(function () {
        ...
        if ($('.coach-slider').length) {
            $('.coach-slider').slick({
                ...
                autoplay: false,            // Enable automatic slide transition
                autoplaySpeed: 5000,       // Delay between autoplay transitions (ms)
                arrows: false,             // Hide next/prev arrows
                dots: true,
                dotsClass: 'slick-dots',// Show navigation dots
                responsive: [              // Responsive settings
                    {
                        breakpoint: 1199,  // Screen width <= 1199px
                        settings: {
                            slidesToShow: 2 // Show 2 slides
                        }
                    },
                    {
                        breakpoint: 767,   // Screen width <= 767px
                        settings: {
