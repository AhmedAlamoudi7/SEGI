...
var KTModalNewTarget = function () {
    ...
    var handleForm = function () {
        ...
        function submitId() {
            ...
            let image_white = $("#name_image_white")[0].files[0];
            let image_dark = $("#name_image_dark")[0].files[0];

            let formData = new FormData();
            formData.append("logo_dark", image_dark);
            formData.append("logo_white", image_white);
            formData.append("email", $("#name_email").val());
            formData.append("location", $("#name_location").val());
            formData.append("x", $("#name_x").val());
            formData.append("faceBook", $("#name_faceBook").val());
            formData.append("youtube", $("#name_youtube").val());
            formData.append("linkedIn", $("#name_linkedIn").val());
            formData.append("tikTok", $("#name_tikTok").val());
            formData.append("snapchat", $("#name_snapchat").val());
            formData.append("instagram", $("#name_instagram").val());
            formData.append("phone", $("#name_phone").val());



            $.ajax({
                type: 'POST',
                url: '/ControlPanel/AdminFixedItem/Edit/' + id + '',
